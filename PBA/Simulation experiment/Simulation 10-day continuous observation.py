"""
The script is designed for a simulation experiment: continuous observation for 10 days, totaling 20 hours.
It generates bursts using random numbers and performs periodic search using PBA.
Before running this script, please first calculate the FAP distribution for the continuous observation of 10 days and 20 hours
