"""
This script is used to calculate the FAP distribution in the observation of FRB 20190520B.
Based on different energy segments, FRB 20190520B has different observation windows (adjusted according to data completeness).
It calculates the FAP distribution of PBA for non-periodic bursts within these observation windows.
